...
public:
    ...
    bool Update(const LiDARObjectListPtr &lidar_obj_list,const std::map<size_t,int>& map);
    bool Update(const CameraObjectListPtr &camera_obj_list,const std::map<size_t,int>& map);
    bool Update(const RadarObjectListPtr &radar_obj_list,const std::map<size_t,int>& map);
